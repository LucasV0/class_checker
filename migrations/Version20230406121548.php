 ...
 */
final class Version20230406121548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE to_have (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, lesson_id INT NOT NULL, INDEX IDX_3590FB8FCB944F1A (student_id), INDEX IDX_3590FB8FCDF80196 (lesson_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE to_have ADD CONSTRAINT FK_3590FB8FCB944F1A FOREIGN KEY (student_id) REFERENCES student (id)');
        $this->addSql('ALTER TABLE to_have ADD CONSTRAINT FK_3590FB8FCDF80196 FOREIGN KEY (lesson_id) REFERENCES lesson (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE to_have DROP FOREIGN KEY FK_3590FB8FCB944F1A');
        $this->addSql('ALTER TABLE to_have DROP FOREIGN KEY FK_3590FB8FCDF80196');
